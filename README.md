...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-04 17:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e1afde24-eb50-471d-a2be-101ace93814b.git
$ cd e1afde24-eb50-471d-a2be-101ace93814b
```
